...
## 前言
在Web开发过程中，我们会遇到各种各样繁杂的名词比如HTML、HTML5、XHTML、CSS、SQL、JavaScript、PHP、JSP、ASP、WebServices、WebServices、浏览器脚本、服务器脚本近来又是nodejs，express，mongoDB等。种类繁多让人不解。究竟web开发的流程是怎样的呢？所有的这些技术之间的关系和应用范围又是怎么样的？我将根据自己现在所理解的情况，通俗地给大家讲解一下。
## web开发的相关技术和概念
### 网站访问大概是什么个过程?
